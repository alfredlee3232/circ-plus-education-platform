...
# =====================================================
    ...
    st.write("Nitric Oxide is the main focus of this education platform. Other modules support sports nutrition learning.")

    # Large Nitric Oxide module on Home page
    st.markdown("""
    <div style="
        ...
        margin-top: 20px;
        margin-bottom: 18px;
        box-shadow: 0px 18px 45px rgba(56, 189, 248, 0.20);
    ">
        <div style="font-size: 44px; font-weight: 900; color: white; margin-bottom: 12px;">
    ...
    if st.button("Learn More About Nitric Oxide", key="home_no_main", use_container_width=True):
        go_to("Nitric Oxide")
    ...
    with m6:
        st.markdown("""
        <div class="module-box">
            <div class="card-title">🤖 AI Learning Plan</div>
            <div class="card-text">
                Future chatbot and gamified quiz plan for personalised education engagement.
            </div>
        </div>
        """, unsafe_allow_html=True)

        if st.button("View Plan", key="home_ai_plan", use_container_width=True):
            go_to("AI Gamification")
